...
<div>
    <x-admin-panel>
        ...
        <x-slot name="desc">
            ...
            {{ __('You can create, edit, enable/disable, or delete SEO entries here.') }}
        </x-slot>
        <x-slot name="button">
            <div class="flex gap-x-2">
                <a href="{{ route('admin.atu.rank-seo.settings') }}"
                    class="bg-black dark:bg-gray-700 text-white hover:bg-gray-800 dark:hover:bg-gray-600 px-3 py-2 rounded-md text-sm font-bold">
                    Global Settings
                </a>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-600">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            <th scope="col" class="py-3.5 pr-3 pl-4 text-left text-sm font-semibold text-gray-900 dark:text-gray-100 sm:pl-3">Slug Registry ID</th>
                            <th scope="col" class="py-3.5 pr-3 pl-4 text-left text-sm font-semibold text-gray-900 dark:text-gray-100 sm:pl-3">Type</th>
                    ...
                    <tbody class="bg-white dark:bg-gray-800">
                        @if ($this->seoEntries->isNotEmpty())
                            @foreach ($this->seoEntries as $entry)
                                <tr class="even:bg-gray-50 dark:even:bg-gray-800/50">
                                    <td class="py-4 pr-3 pl-4 text-sm font-medium whitespace-nowrap text-gray-900 dark:text-gray-100 sm:pl-3">{{ $entry->slug_registry_id ?? 'N/A' }}</td>
                                    ...
                                    <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">{{ Str::limit($entry->title ?? 'N/A', 50) }}</td>
        ...
        <script>
            $js('confirmDelete', (id) => {
                Swal.fire({
                    ...
                    text: "This SEO entry will be removed permanently.",
                    icon: 'warning',
